...
class JFormFieldImagePicker extends JFormField
{
	...
	protected function getInput()
	{
		...
		$doc->addStyleSheet( JURI::root(TRUE) . '/modules/mod_ateam/assets/css/image-picker.css' );
		$doc->addScript( JURI::root(TRUE) . '/modules/mod_ateam/assets/js/image-picker.min.js' );
